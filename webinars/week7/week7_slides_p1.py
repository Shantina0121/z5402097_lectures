...
printit(ser2,"sorted by index")

ser2.sort_values(inplace=True)
printit(ser2,"sorted by value")
...
res = df.loc[:,'close']
print(res)#result is series

res = df.loc[:,['close']]
print(res)#result is df

res = df.loc['2020-01-02',:]
print(res)#result is series.Series
